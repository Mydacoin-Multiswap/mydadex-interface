import { ChainId, Ether, SUSHI_ADDRESS, Token, WETH9, WNATIVE } from 'mydaswapsdk'
...
export const SUSHI: ChainTokenMap = {
  [ChainId.MAINNET]: new Token(ChainId.MAINNET, SUSHI_ADDRESS[ChainId.MAINNET], 18, 'MYDA', 'MYDA'),
  [ChainId.ROPSTEN]: new Token(ChainId.ROPSTEN, SUSHI_ADDRESS[ChainId.ROPSTEN], 18, 'MYDA', 'Myda Coin'),
  [ChainId.RINKEBY]: new Token(ChainId.RINKEBY, SUSHI_ADDRESS[ChainId.ROPSTEN], 18, 'MYDA', 'Myda Coin'),
  [ChainId.GÖRLI]: new Token(ChainId.GÖRLI, SUSHI_ADDRESS[ChainId.GÖRLI], 18, 'MYDA', 'MYDA'),
  [ChainId.KOVAN]: new Token(ChainId.KOVAN, SUSHI_ADDRESS[ChainId.KOVAN], 18, 'MYDA', 'MYDA'),
  [ChainId.MATIC]: new Token(ChainId.MATIC, SUSHI_ADDRESS[ChainId.MATIC], 18, 'MYDA', 'MYDA'),
  [ChainId.FANTOM]: new Token(ChainId.FANTOM, SUSHI_ADDRESS[ChainId.FANTOM], 18, 'MYDA', 'MYDA'),
  [ChainId.XDAI]: new Token(ChainId.XDAI, SUSHI_ADDRESS[ChainId.XDAI], 18, 'MYDA', 'MYDA'),
  [ChainId.BSC]: new Token(ChainId.BSC, SUSHI_ADDRESS[ChainId.BSC], 18, 'MYDA', 'MYDA'),
  [ChainId.BSC_TESTNET]: new Token(ChainId.BSC, SUSHI_ADDRESS[ChainId.BSC_TESTNET], 18, 'MYDA', 'Myda Coin'),
  [ChainId.ARBITRUM]: new Token(ChainId.ARBITRUM, SUSHI_ADDRESS[ChainId.ARBITRUM], 18, 'MYDA', 'MYDA'),
  [ChainId.AVALANCHE]: new Token(ChainId.AVALANCHE, SUSHI_ADDRESS[ChainId.AVALANCHE], 18, 'MYDA', 'MYDA'),
  [ChainId.OKEX]: new Token(ChainId.OKEX, SUSHI_ADDRESS[ChainId.OKEX], 18, 'MYDA', 'MYDA'),
  [ChainId.HARMONY]: new Token(ChainId.HARMONY, SUSHI_ADDRESS[ChainId.HARMONY], 18, 'MYDA', 'MYDA'),
  [ChainId.HECO]: new Token(ChainId.HECO, SUSHI_ADDRESS[ChainId.HECO], 18, 'MYDA', 'MYDA'),
  [ChainId.HECO_TESTNET]: new Token(ChainId.HECO_TESTNET, SUSHI_ADDRESS[ChainId.HECO_TESTNET], 18, 'MYDA', 'Myda Coin'),
}
