...
import { Currency, CurrencyAmount, Percent, WNATIVE, currencyEquals } from 'mydaswapsdk'
    ...
    <>
      <Head>
        ...
        <meta
          key="description"
          name="description"
          content="Add liquidity to the MydaDex AMM to enable gas optimised and low slippage trades across countless networks"
        />
      </Head>
