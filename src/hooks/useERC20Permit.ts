import { Currency, CurrencyAmount, JSBI, Percent, Token, TradeType, Trade as V2Trade } from 'mydaswapsdk'
...
const PERMITTABLE_TOKENS: {
  ...
  [1]: {
    ...
    [SUSHI[1].address]: { type: PermitType.AMOUNT, name: 'MydaDex' },
  },
  [4]: {
    ...
    [SUSHI[4].address]: { type: PermitType.AMOUNT, name: 'MydaDex' },
  },
  [3]: {
    [SUSHI[3].address]: { type: PermitType.AMOUNT, name: 'MydaDex' },
  ...
  [5]: {
    [SUSHI[5].address]: { type: PermitType.AMOUNT, name: 'MydaDex' },
  },
  [42]: {
    [SUSHI[42].address]: { type: PermitType.AMOUNT, name: 'MydaDex' },
  },
}
